    ...
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult> Index(int mes, int year)
        {
            ...
            var modelo = await servicioReportes
                .ObtenerReporteTransaccionesDetalladas(usuarioId, mes, year, ViewBag);
        ...
        public async Task<IActionResult> Semanal(int mes, int year)
        {
            ...
            IEnumerable<ResultadoObtenerPorSemana> transaccionesPorSemana =
                await servicioReportes.ObtenerReporteSemanal(usuarioId, mes, year, ViewBag);
            ...
            for (int i = 0; i < diasSegmentados.Count(); i++)
            {
                ...
                var grupoSemana = agrupado.FirstOrDefault();
        ...
        public async Task<FileResult> ExportarExcelTodo()
        {
            ...
            var nombreArchivo = $"Manejo Prespuestos - {DateTime.Today.ToString("dd-MM-yyyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        private async Task<IEnumerable<SelectListItem>> ObtenerCategorias(int usuarioId, TipoOperacion tipoOperacion)
        {
            ...
            //el x => new... configura el llenado para la etiqueta select de categorias de acuerdo
            //a lo que retorna la consulta en repositorio categorias
        }
        [HttpPost]
        public async Task<IActionResult> ObtenerCategorias([FromBody] TipoOperacion tipoOperacion)
        {
            ...
            //Ok quiere decir que la respuesta fue exitosa y envía la variable categorias
        }
